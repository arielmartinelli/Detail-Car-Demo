...
export const BEFORE_AFTER_PRESETS: BeforeAfterPreset[] = [
  {
    ...
    serviceName: 'Acondicionamiento Pre-Venta',
    beforeLabel: 'Antes',
    afterLabel: 'Después',
    beforeImg: '/img/preventa_before.jpg',
    afterImg: '/img/preventa_after.jpg',
    description: 'Rejuvenecimiento total para publicación.',
  },
  {
    id: 'paint-correction',
    title: 'Tratamiento Pintura',
    vehicle: 'Volkswagen Golf GTI',
    serviceName: 'Tratamiento Cerámico 9H & Pulido',
    beforeLabel: 'Antes',
    afterLabel: 'Después',
    beforeImg: '/img/paint_before.jpg',
    afterImg: '/img/paint_after.jpg',
    description: 'Eliminación de rayas circulares y sellado cerámico.',
  },
  {
    id: 'interior-detail',
    title: 'Interiores',
    ...
    description: 'Inyección-extracción a vapor y cuero mate.',
  },
];
